...
function updateRecord(formData1){
  selectedRow.cells[0].innerHTML = formData1.fullName;
  selectedRow.cells[1].innerHTML = formData1.empID;
  selectedRow.cells[2].innerHTML = formData1.salary;
  selectedRow.cells[3].innerHTML = formData1.city;
}
